...
class vaeSVHN(nn.Module) :
	...
	# Constructor
	def __init__(self, config_enc, config_dec, device, architecture = 'Standard') :

		"""
		inputs :

		config_enc :
			A class/dict with configuration details for the encoder
		config_dec :
			A class/dict with configuration details for the decoder
		device :
